...
namespace OnlineShop.Core
{
    public class Controller : IController
    {
        ...
        public string RemoveComponent(string componentType, int computerId)
        {
            ...
            var component = this.computers.FirstOrDefault(x => x.Id == computerId)
                .RemoveComponent(componentType);

            // TODO: computerID or componentID?!?
        ...
        private void DoesComputerExist(int id)
        {
            if (!this.computers.Any(x => x.Id == id))
            {
                throw new ArgumentException("omputer with this id does not exist.");
            }
        }
    }
}
